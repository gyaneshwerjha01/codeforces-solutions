...
void solve() {
    ...
    int count_two = 0;
    int first_index_of_two = -1;
    int count_again_two = 0;
    FOR(i, 0, n){
        if(v[i] == 2){
            count_two += 1;
        }
    ...
    if(count_two % 2 != 0){
        ...
        int half = count_two / 2;
        FOR(i, 0, n){
            if(v[i] == 2){
                count_again_two += 1;
                if(count_again_two == half && first_index_of_two == -1){
                    first_index_of_two = i;
                    break;
                }
            }
        }
    }
    cout<<first_index_of_two + 1 <<endl;
